...
class LessonMonday3 extends StatefulWidget {
  const LessonMonday3({Key? key});

  @override
  _LessonMonday3State createState() => _LessonMonday3State();
}

class _LessonMonday3State extends State<LessonMonday3> {
  String _subject = '';
  String _group = '';
  String _subjecttype = '';
  ...
  Future<void> getData() async {
    try {
      ...
      final url = 'http://172.20.10.14:8000/api/rasp/detail/3/';
