...
class LessonFriday4 extends StatefulWidget {
  LessonFriday4({Key? key});

  @override
  _LessonTuesday1State createState() => _LessonTuesday1State();
}

class _LessonTuesday1State extends State<LessonFriday4> {
  String _subject = '';
  String _group = '';
  String _subjecttype = '';
  String _days = '';
  ...
  Future<void> getData() async {
    try {
      ...
      final url = 'http://172.20.10.14:8000/api/rasp/detail/20/';
