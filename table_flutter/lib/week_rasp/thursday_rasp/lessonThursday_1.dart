...
class LessonThursday1 extends StatefulWidget {
  LessonThursday1({Key? key});

  @override
  _LessonTuesday1State createState() => _LessonTuesday1State();
}

class _LessonTuesday1State extends State<LessonThursday1> {
  String _subject = '';
  String _group = '';
  String _subjecttype = '';
  String _days = '';
  ...
  Future<void> getData() async {
    try {
      ...
      final url = 'http://172.20.10.14:8000/api/rasp/detail/13/';
