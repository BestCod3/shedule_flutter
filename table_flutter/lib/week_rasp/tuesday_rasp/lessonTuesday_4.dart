...
class LessonTuesday4 extends StatefulWidget {
  LessonTuesday4({Key? key});

  @override
  _LessonTuesday4State createState() => _LessonTuesday4State();
}

class _LessonTuesday4State extends State<LessonTuesday4> {
  String _subject = '';
  String _group = '';
  String _subjecttype = '';
  String _days = '';
  ...
  Future<void> getData() async {
    try {
      ...
      final url = 'http://172.20.10.14:8000/api/rasp/detail/8/';
