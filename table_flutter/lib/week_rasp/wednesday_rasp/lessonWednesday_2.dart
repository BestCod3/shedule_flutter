...
class LessonWednesday2 extends StatefulWidget {
  const LessonWednesday2({
    Key? key,
  });
...
class _LessonMonday1State extends State<LessonWednesday2> {
  String _subject = '';
  String _group = '';
  String _subjecttype = '';
  String _days = '';
  ...
  Future<void> getData() async {
    try {
      ...
      final url = 'http://172.20.10.14:8000/api/rasp/detail/10/';
