...
class LessonWednesday4 extends StatefulWidget {
  const LessonWednesday4({
    Key? key,
  });
...
class _LessonMonday1State extends State<LessonWednesday4> {
  String _subject = '';
  String _group = '';
  String _subjecttype = '';
  String _days = '';
  ...
  Future<void> getData() async {
    try {
      ...
      final url = 'http://172.20.10.14:8000/api/rasp/detail/12/';
